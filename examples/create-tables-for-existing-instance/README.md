...
This example creates an OTS instance and multiple tables for it.
...
|------|-------------|------|---------|----------|
| <a name="input_instance_name"></a> [instance\_name](#input\_instance\_name) | The name of the OTS instance to create. | `string` | `"tfots2"` | no |
